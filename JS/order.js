class OrderConfirmation {
  ...
  resetOrderPage() {
    ...
    // Enable the quantity inputs for removed items
    const removedItems = document.querySelectorAll('#add-order-form .quantity:disabled');
  ...
  calculateTotalPrice() {
    ...
    orderItems.forEach((item) => {
      ...
      const quantity = parseInt(
        item.querySelector("td:nth-child(3) input").value,
        10
      );
...
document
  ...
  .addEventListener("click", () => orderConfirmation.confirmOrder());
